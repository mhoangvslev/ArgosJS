...
export class AppComponent {
  ...
  ngOnInit(){
    this.setupForm = this.formBuildier.group({
      ethersProvider: ['http://127.0.0.1:7545', Validators.required],
      ...
      ethersAddr: ['0xfDEAA4ab9fea519aFD74df2257A21e5BcA0DFd3f', Validators.required],
      ethersName: ['CustomToken', Validators.required]
    });
  }
  ...
  initArgos(){
    ...
    const provider = ctrl.ethersProvider.value;
    const abi = ctrl.ethersAbi.value;
    const addr = ctrl.ethersAddr.value;
    const contractName = ctrl.ethersName.value;

    this.contractService = new ContractsService(provider, abi, addr, contractName);
