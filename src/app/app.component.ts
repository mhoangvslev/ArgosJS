...
export class AppComponent {
  ...
  initArgos(){
    ...
    // Contract service
    this.contractService = new ContractsService(abi, addr, new DatabaseService());
    this.contractService.Listen_ERC20();
  }
